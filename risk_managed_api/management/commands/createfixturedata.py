...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        email_list = [
            "bobjones@bobjones.com ",
            "jimbob@jimbob.com  ",
            "joey@joey.com",
            "sarahmarshall@sarahmarshall.com",
            "josh@josh.com",
            "john@john.com",
        ]
        ...
        response = urllib.request.urlopen(
            "http://www.json-generator.com/api/json/get/cjAElSKJTS?indent=2"
        )
        ...
        # Get `json` data
        response = urllib.request.urlopen(
            "http://www.json-generator.com/api/json/get/bVIMfRScya?indent=2"
        )
        ...
        # Get `json` data
        response = urllib.request.urlopen(
            "http://www.json-generator.com/api/json/get/cjLssdDLDm?indent=2"
        )
        ...
        for i in range(500):
            ...
            try:
                with open(
                    ...
                    name = os.path.join(
                        "images", "guests", str(identity.id) + "-" + str(event.id) + "-image.jpg"
                    )
                    GuestRegistration.objects.create(
                        identity=identity, event=event, image=SimpleUploadedFile(name, f.read())
                    )
